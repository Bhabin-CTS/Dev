...
{
    /// <inheritdoc />
    public partial class Report_usp_OverallSummary : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"
            CREATE OR ALTER PROCEDURE [dbo].[usp_OverallSummary]
            (
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS [dbo].[usp_OverallSummary];");
        }
    }
}
